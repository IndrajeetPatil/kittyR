# Getting help with kittyR

Thanks for using kittyR. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/kittyR/issues) to make sure the 
